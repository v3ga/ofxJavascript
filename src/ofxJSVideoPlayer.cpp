...
//--------------------------------------------------------------
OFX_INST_DEFINE_JSFUNC_1(ofxJSVideoPlayer,setVolume,float,m_videoPlayer)
//--------------------------------------------------------------
...
OFX_INST_DEFINE_JSFUNC_2(ofxJSVideoPlayer,setAnchorPoint,float,float,m_videoPlayer)
