...
static JSBool JSFUNC_closeMovie(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);
...
static JSBool JSFUNC_firstFrame(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);

/* Function: int					getCurrentFrame() */
static JSBool JSFUNC_getCurrentFrame(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);

/* Function: float 				getDuration() */
static JSBool JSFUNC_getDuration(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);

/* Function: bool				getIsMovieDone() */
static JSBool JSFUNC_getIsMovieDone(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);
...
static JSBool JSFUNC_getTotalNumFrames(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);

/* Function: void 				idleMovie() */
static JSBool JSFUNC_idleMovie(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);
...
static JSBool JSFUNC_loadMovie(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);

/* Function: void				nextFrame() */
static JSBool JSFUNC_nextFrame(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);

/* Function: void 				play() */
static JSBool JSFUNC_play(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);

/* Function: void				previousFrame() */
static JSBool JSFUNC_previousFrame(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);
...
static JSBool JSFUNC_setFrame(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);

/* Function: void 				setLoopState(int state) */
static JSBool JSFUNC_setLoopState(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval);
